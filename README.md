...
| **Kuai Yu**     | Using streamlined code to explore the data, and added new columns based on the study, the data was divided into two parts from the standard line and expressed as binomial value. The visualization is clearly labled, easy to understand   | The sub question was simple. And for result, the accuracy is unsecured   |
