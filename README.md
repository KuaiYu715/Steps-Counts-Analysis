...
* The relationships between steps and weather and temperature are shown clearly by the report. People may not willing to walk like shower or hot days. Some medical orginzation can remind people to walk or do some activities instead. Based on trends in our research, we alert users to daily activities at times when step counts are likely to be low to avoid potential health risk.
